...
const Popup = () => {
	...
	const content = (
		<List header={<div>User01</div>} className={styles.popupContent}>
...
function MyLayout() {
	...
	return (
		<Layout>
			...
			<Footer className={styles.footer}>Powered by&nbsp;<a href="https://github.com/">Ou Yang</a>&nbsp;|&nbsp;<a href="https://policies.google.com/privacy">Privacy</a> </Footer>
